// lib/render.js
// Server-side template rendering for the static site.
//
// Strategy:
//   1. src/index.template.html contains token comments like <!--@@HIGHLIGHTS@@-->
//      where dynamic content is injected.
//   2. On boot we read the template once and keep it as the template source.
...
// Template source for the page. Root index.html is a BUILD ARTIFACT (produced
// by scripts/build.js) for static hosting; this module reads only the template.
